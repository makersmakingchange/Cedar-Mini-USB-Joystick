/* 
* File: Cedar_USB_Joystick_Firmware.ino
* Software: Cedar USB Joystick Plus 4 Switches, with both USB gamepad and mouse funtionality.
...
#define UPDATE_INTERVAL   5 // Update interval for perfoming HID actions (in milliseconds)
...
#define SWITCH_JOY_PIN    10 // Switch built int the joystick (press down)
